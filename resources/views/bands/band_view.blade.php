    ...
    <div class="mx-auto text-center mt-4">
        ...
        @if(count($band->albuns) == 0)
            ...
            @if(Auth::user()->perfil == $admin)
                <a class="btn btn-primary col-6 mx-auto btn-detail mt-5" href="{{route('createAlbum')}}"> Adicionar um Álbum </a>
                    ...
                    <div class="col-md-3">
                        <div class="card mb-3 mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">{{$album->data_lancamento}}</p>
                                <a href="#" class="btn btn-primary btn-detail" data-mdb-ripple-init>Editar álbum</a>
                            </div>
                        </div>
                    </div>
                @endforeach
